                ...
                <div className="scrollRight">
                    <div className="right">
                        ...
                        <NoticesRight 
                            ...
                            resumo="A Netflix divulgou o elenco da série live-action de One Piece nesta terça-feira (9). Os atores Iñaki Godoy e Mackenyu (Samurai X) foram escalados para interpretar Monkey D. Luffy e Roronoa Zoro, respectivamente.

                            Jacob Romero Gibson (Greenleaf) será Usopp, Emily Rudd (Rua do Medo) será a ladra de piratas Nami, enquanto o maior cozinheiro de East Blue, Sanji, será interpretado por Taz Skylar (Villain). O capítulo de estreia do live-action é assinado por Matt Owens (Luke Cage) e Steven Maeda (Lost). A página de rosto do roteiro credita o criador do mangá original de One Piece, Eiichiro Oda.Publicada desde 1997 no Japão, a trama acompanha Monkey D. Luffy - que, junto com seus amigos, parte em busca de um tesouro que irá lhe consagrar como o rei dos piratas. Em 1999, One Piece ganhou um anime, que está no ar até hoje e já passa dos 900 episódios.
